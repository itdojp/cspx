...
generate_philosopher_loops_model() {
  local output_path="$1"
  ...
  {
    echo "-- Generated by problems/generators/regenerate_p900_p905.sh"
    echo "-- Family: philosopher-loops-interleaving, scale: ${scale}, philosophers: ${philosophers}"
...
generate_philosopher_loops_model "${PROBLEMS_DIR}/P901_dining_philosophers_small/model.cspm" 3 "tiny"
...
generate_philosopher_loops_model "${PROBLEMS_DIR}/P904_dining_philosophers_medium/model.cspm" 5 "medium"
